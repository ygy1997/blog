...
class Category(models.Model):
    ...
    # 对应导航菜单外键
    bigcategory = models.ForeignKey(BigCategory, verbose_name='大分类',on_delete=DO_NOTHING)
...
class Article(models.Model):
            ...
            # 文章作者
            author = models.ForeignKey(settings.AUTH_USER_MODEL,verbose_name='作者',on_delete=DO_NOTHING)
 ...
 upload_settings={"imageMaxSize":1204000},settings={}, verbose_name='内容')
            ...
            # 文章唯一标识符
            slug = models.SlugField(unique=True)
            category = models.ForeignKey(Category, verbose_name='文章分类',on_delete=DO_NOTHING)
